...
@app.route('/dbview/')
@app.route('/dbview/<db>/', methods=["GET", "POST"])
@login_required
def views_db101(db=None):
    ...
    return render_template('db/dbview.html',
             title = 'Databases',
             names = names,
             rows = dbs_table,
             obj = obj,
...
@app.route('/dbview/info/<db>/<table>')
@login_required
...
@app.route('/dbview/info/<db>/<table>/<column>')
@login_required
...
@app.route('/dbview/distinct/<db>/<table>/<column>')
@login_required
...
@app.route('/dbview/<db>/<table>/', methods=["GET", "POST"])
@login_required
